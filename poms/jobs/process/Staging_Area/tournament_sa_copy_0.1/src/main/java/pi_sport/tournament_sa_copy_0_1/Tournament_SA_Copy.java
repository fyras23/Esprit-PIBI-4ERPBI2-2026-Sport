...
package pi_sport.tournament_sa_copy_0_1;
...
/**
 * Job: Tournament_SA_Copy Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Tournament_SA_Copy implements TalendJob {
	...
	private final String jobName = "Tournament_SA_Copy";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Tournament_SA_Copy.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Tournament_SA_Copy.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class tournamentsStruct implements routines.system.IPersistableRow<tournamentsStruct> {
		final static byte[] commonByteArrayLock_PI_SPORT_Tournament_SA_Copy = new byte[0];
		static byte[] commonByteArray_PI_SPORT_Tournament_SA_Copy = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PI_SPORT_Tournament_SA_Copy.length) {
					if (length < 1024 && commonByteArray_PI_SPORT_Tournament_SA_Copy.length == 0) {
						commonByteArray_PI_SPORT_Tournament_SA_Copy = new byte[1024];
					} else {
						commonByteArray_PI_SPORT_Tournament_SA_Copy = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PI_SPORT_Tournament_SA_Copy, 0, length);
				strReturn = new String(commonByteArray_PI_SPORT_Tournament_SA_Copy, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PI_SPORT_Tournament_SA_Copy, 0, length);
				strReturn = new String(commonByteArray_PI_SPORT_Tournament_SA_Copy, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PI_SPORT_Tournament_SA_Copy) {
		 ...
		 * Compare keys
		 */
		public int compareTo(tournamentsStruct other) {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PI_SPORT_Tournament_SA_Copy) {
				...
				try {
					...
					this.prizemoney = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.prizemoney, dos);
		...
		public String toString() {
			...
			sb.append(",prizemoney=" + String.valueOf(prizemoney));
			sb.append(",categorie=" + categorie);
			sb.append(",country=" + country);
			sb.append("]");
	...
	public void tFileList_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				tournamentsStruct tournaments = new tournamentsStruct();
				...
				String directory_tFileList_2 = "C:/Users/firas/Desktop/pi_sport/tour";
				...
				for (int i_tFileList_2 = 0; i_tFileList_2 < list_tFileList_2.size(); i_tFileList_2++) {
					...
					if (execStat) {
						runStat.updateStatOnConnection("tournaments", 3, 0);
					}
					...
					if (execStat) {
						runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "tournaments");
					}

					int tos_count_tDBOutput_1 = 0;

					String dbschema_tDBOutput_1 = null;
					dbschema_tDBOutput_1 = "Padel";

					String tableName_tDBOutput_1 = null;
					if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
						tableName_tDBOutput_1 = ("Tournament_SA");
					} else {
						tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("Tournament_SA");
					}
					...
					final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
							"enc:routine.encryption.key.v1:s6JFTr94B7su/94oCsSUeWPKNmFHJBZDl81bpGvbJza/aAbFZw==");
					...
					String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
							+ "\" (\"Player Name\",\"Tournament Name\",\"Year\",\"Round Reached\",\"Matches Played\",\"Points Earned\",\"StartDate\",\"EndDate\",\"PrizePoll\",\"categorie\",\"country\",\"Matches Won\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
...
// # Outputs initialization
					tournamentsStruct tournaments_tmp = new tournamentsStruct();
// ###############################
					...
					final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
							.decryptPassword("enc:routine.encryption.key.v1:mM2TUa9y5fKuphY93VgqYzhDwaOXv1/Wi3GOBg==");
							...
							for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
								...
								try {
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
										curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
												+ start_column_tFileInputExcel_1 + 1;
										curColName_tFileInputExcel_1 = "Round_Reached";

										row1.Round_Reached = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
									} else {
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
										curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
												+ start_column_tFileInputExcel_1 + 1;
										curColName_tFileInputExcel_1 = "Matches_Played";

										row1.Matches_Played = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
									} else {
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
										curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
												+ start_column_tFileInputExcel_1 + 1;
										curColName_tFileInputExcel_1 = "Matches_Won";

										row1.Matches_Won = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
									} else {
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
										curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
												+ start_column_tFileInputExcel_1 + 1;
										curColName_tFileInputExcel_1 = "Points_Earned";

										row1.Points_Earned = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
									} else {
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
										curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
												+ start_column_tFileInputExcel_1 + 1;
										curColName_tFileInputExcel_1 = "dateDebut";

										row1.dateDebut = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
									} else {
										row1.dateDebut = null;
										emptyColumnCount_tFileInputExcel_1++;
									}
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
										curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
												+ start_column_tFileInputExcel_1 + 1;
										curColName_tFileInputExcel_1 = "dateFin";

										row1.dateFin = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
									} else {
										row1.dateFin = null;
										emptyColumnCount_tFileInputExcel_1++;
									}
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
										curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
												+ start_column_tFileInputExcel_1 + 1;
										curColName_tFileInputExcel_1 = "prizemoney";

										row1.prizemoney = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
									} else {
										row1.prizemoney = null;
										emptyColumnCount_tFileInputExcel_1++;
									}
...
// # Output table : 'tournaments'
										tournaments_tmp.Player_Name = row1.Player_Name;
										tournaments_tmp.Tournament_Name = row1.Tournament_Name;
										tournaments_tmp.Year = null;
										tournaments_tmp.Round_Reached = row1.Round_Reached;
										tournaments_tmp.Matches_Played = row1.Matches_Played;
										tournaments_tmp.Points_Earned = row1.Points_Earned;
										tournaments_tmp.StartDate = row1.dateDebut;
										tournaments_tmp.EndDate = row1.dateFin;
										tournaments_tmp.PrizePoll = row1.prizemoney;
										tournaments_tmp.categorie = row1.categorie;
										tournaments_tmp.country = row1.country;
										tournaments_tmp.Matches_Won = row1.Matches_Won;
										tournaments = tournaments_tmp;
// ###############################
...
// Start of branch "tournaments"
									if (tournaments != null) {
										...
										if (tournaments.Player_Name == null) {
											pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(1, tournaments.Player_Name);
										}

										if (tournaments.Tournament_Name == null) {
											pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(2, tournaments.Tournament_Name);
										}

										if (tournaments.Year == null) {
											pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(3, tournaments.Year);
										}

										if (tournaments.Round_Reached == null) {
											pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(4, tournaments.Round_Reached);
										}

										if (tournaments.Matches_Played == null) {
											pstmt_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
										} else {
											pstmt_tDBOutput_1.setInt(5, tournaments.Matches_Played);
										}

										if (tournaments.Points_Earned == null) {
											pstmt_tDBOutput_1.setNull(6, java.sql.Types.INTEGER);
										} else {
											pstmt_tDBOutput_1.setInt(6, tournaments.Points_Earned);
										}

										if (tournaments.StartDate == null) {
											pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(7, tournaments.StartDate);
										}

										if (tournaments.EndDate == null) {
											pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(8, tournaments.EndDate);
										}

										if (tournaments.PrizePoll == null) {
											pstmt_tDBOutput_1.setNull(9, java.sql.Types.INTEGER);
										} else {
											pstmt_tDBOutput_1.setInt(9, tournaments.PrizePoll);
										}

										if (tournaments.categorie == null) {
											pstmt_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(10, tournaments.categorie);
										}

										if (tournaments.country == null) {
											pstmt_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(11, tournaments.country);
										}

										if (tournaments.Matches_Won == null) {
											pstmt_tDBOutput_1.setNull(12, java.sql.Types.INTEGER);
										} else {
											pstmt_tDBOutput_1.setInt(12, tournaments.Matches_Won);
										}
...
// ###############################      
					...
					if (execStat) {
						runStat.updateStat(resourceMap, iterateId, 2, 0, "tournaments");
					}
	...
	public static void main(String[] args) {
		final Tournament_SA_Copy Tournament_SA_CopyClass = new Tournament_SA_Copy();

		int exitCode = Tournament_SA_CopyClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Tournament_SA_Copy.class.getClassLoader()
					.getResourceAsStream("pi_sport/tournament_sa_copy_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Tournament_SA_Copy.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Tournament_SA_Copy");
		}
...
/************************************************************************************************
 * 88963 characters generated by Talend Open Studio for Data Integration on the
 * 2 mars 2026 à 01:28:13 WAT
 ************************************************************************************************/