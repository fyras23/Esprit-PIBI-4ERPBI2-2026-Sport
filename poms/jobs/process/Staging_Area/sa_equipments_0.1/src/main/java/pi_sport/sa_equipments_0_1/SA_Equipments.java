...
package pi_sport.sa_equipments_0_1;
 ...
 * @status
 */
public class SA_Equipments implements TalendJob {
	...
	private final String jobName = "SA_Equipments";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					SA_Equipments.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(SA_Equipments.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class equiStruct implements routines.system.IPersistableRow<equiStruct> {
		final static byte[] commonByteArrayLock_PI_SPORT_SA_Equipments = new byte[0];
		static byte[] commonByteArray_PI_SPORT_SA_Equipments = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PI_SPORT_SA_Equipments.length) {
					if (length < 1024 && commonByteArray_PI_SPORT_SA_Equipments.length == 0) {
						commonByteArray_PI_SPORT_SA_Equipments = new byte[1024];
					} else {
						commonByteArray_PI_SPORT_SA_Equipments = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PI_SPORT_SA_Equipments, 0, length);
				strReturn = new String(commonByteArray_PI_SPORT_SA_Equipments, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PI_SPORT_SA_Equipments, 0, length);
				strReturn = new String(commonByteArray_PI_SPORT_SA_Equipments, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PI_SPORT_SA_Equipments) {
		 ...
		 * Compare keys
		 */
		public int compareTo(equiStruct other) {
	...
	public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				equiStruct equi = new equiStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "equi");
				}
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("SA_Equipments");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("SA_Equipments");
				}
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:QCuPS0zO+bmSNzS772up69DXiMzMwghm2QQIMsrzkQkq3aBPwA==");
				...
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"title\",\"handle\",\"vendor\",\"product_type\",\"tags\",\"created_at\",\"price\",\"collection\",\"professional_player\",\"racket_type\",\"surface\") VALUES (?,?,?,?,?,?,?,?,?,?,?)";
...
// # Outputs initialization
				equiStruct equi_tmp = new equiStruct();
// ###############################
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:PwU33vSJfS9OPXkY2vYX4UVrGHhP7pVt02G0HA==");
				...
				Object source_tFileInputExcel_1 = "C:/Users/firas/Desktop/pi_sport/padel_rackets_randomized.xlsx";
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row1.created_at = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row1.sku = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
...
// Start of branch "row1"
							if (row1 != null) {
								...
								{ // start of Var scope
									...
									Var.var1date = TalendDate.parseDate("yyyy-MM-dd'T'HH:mm:ssXXX", row1.created_at);
									Var.var1 = row1.professional_player;// ###############################
									// ###############################
									// # Output tables
...
// # Output table : 'equi'
									equi_tmp.title = row1.title;
									equi_tmp.handle = row1.handle;
									equi_tmp.vendor = row1.vendor;
									equi_tmp.product_type = row1.product_type;
									equi_tmp.tags = row1.tags;
									equi_tmp.created_at = Var.var1date;
									equi_tmp.price = null;
									equi_tmp.collection = row1.collection;
									equi_tmp.professional_player = row1.professional_player;
									equi_tmp.racket_type = row1.racket_type;
									equi_tmp.surface = row1.surface;
									equi = equi_tmp;
// ###############################
...
// Start of branch "equi"
								if (equi != null) {
									...
									if (equi.title == null) {
										...
										pstmt_tDBOutput_1.setString(1, equi.title);
									}

									if (equi.handle == null) {
										pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(2, equi.handle);
									}

									if (equi.vendor == null) {
										pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(3, equi.vendor);
									}

									if (equi.product_type == null) {
										pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(4, equi.product_type);
									}

									if (equi.tags == null) {
										pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(5, equi.tags);
									}

									if (equi.created_at != null) {
										pstmt_tDBOutput_1.setTimestamp(6,
												new java.sql.Timestamp(equi.created_at.getTime()));
									} else {
									...
									if (equi.price == null) {
										...
										pstmt_tDBOutput_1.setDouble(7, equi.price);
									}

									if (equi.collection == null) {
										pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(8, equi.collection);
									}

									if (equi.professional_player == null) {
										pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(9, equi.professional_player);
									}

									if (equi.racket_type == null) {
										pstmt_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(10, equi.racket_type);
									}

									if (equi.surface == null) {
										pstmt_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(11, equi.surface);
									}
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "equi");
				}
	...
	public static void main(String[] args) {
		final SA_Equipments SA_EquipmentsClass = new SA_Equipments();

		int exitCode = SA_EquipmentsClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = SA_Equipments.class.getClassLoader()
					.getResourceAsStream("pi_sport/sa_equipments_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = SA_Equipments.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SA_Equipments");
		}
...
/************************************************************************************************
 * 90076 characters generated by Talend Open Studio for Data Integration on the
 * 2 mars 2026 à 04:13:02 WAT
 ************************************************************************************************/